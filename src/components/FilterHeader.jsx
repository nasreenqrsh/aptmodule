        ...
        <div className="vwextrabtns">
          <div className="apptstatus">
            ...
            <div className="pndpay statcell">
              <div className="stimg">
                <img src="/images/paymentpend.svg" alt="Payment Pending" />
                Payment Pending
              </div>
            ...
            <div className="ongngappt statcell">
              <div className="stimg">
                <img src="/images/ongoing.png" alt="Active/Ongoing" />
                Active/Ongoing
              </div>
              <div className="statno">5</div>
            </div>
            ...
            <div className="checkin statcell">
              <div className="stimg">
                <img src="/images/checkin.svg" alt="Checked In" />
                Checked In
              </div>
            ...
            <div className="booked statcell">
              <div className="stimg">
                <img src="/images/booked.svg" alt="Booked" />
                Booked
              </div>
