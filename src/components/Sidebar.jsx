...
const handleEditAppointment = (appt) => {
  if (appt && typeof onClose === "function") onClose(); // Close details panel
  if (typeof window.openEditDrawer === "function") {
    window.openEditDrawer(appt); // Temporary global handler, or replace with prop from parent
  }
};
